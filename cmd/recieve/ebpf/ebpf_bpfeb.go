...
type ebpfMapSpecs struct {
	DecapIfaceMap *ebpf.MapSpec `ebpf:"decap_iface_map"`
	OriginsMap    *ebpf.MapSpec `ebpf:"origins_map"`
}
...
type ebpfMaps struct {
	DecapIfaceMap *ebpf.Map `ebpf:"decap_iface_map"`
	OriginsMap    *ebpf.Map `ebpf:"origins_map"`
}
